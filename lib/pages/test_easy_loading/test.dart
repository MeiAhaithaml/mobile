...
class TestEasyLoading extends StatefulWidget {
  const TestEasyLoading({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _TestEasyLoadingState createState() => _TestEasyLoadingState();
}

class _TestEasyLoadingState extends State<TestEasyLoading> {
  Timer? _timer;
